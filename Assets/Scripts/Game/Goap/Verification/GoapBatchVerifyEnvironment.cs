...
public static class GoapBatchVerifyEnvironment
{
    ...
    public static string GetResultFileName(GoapBatchVerifyProfile profile) =>
        profile switch
        {
            ...
            GoapBatchVerifyProfile.RegainStamina => "goap-batch-regain-stamina-result.txt",
    ...
    public static string GetLogFileName(GoapBatchVerifyProfile profile) =>
        profile switch
        {
            ...
            GoapBatchVerifyProfile.RegainStamina => "goap-batch-regain-stamina-verify.log",
    ...
    private static GoapBatchVerifyProfile ParseProfileToken(string token)
    {
        ...
        if (string.Equals(token, "defenseCombinedDrive", StringComparison.OrdinalIgnoreCase)
        ...
        if (string.Equals(token, "regainStamina", StringComparison.OrdinalIgnoreCase)
            || string.Equals(token, "regain-stamina", StringComparison.OrdinalIgnoreCase))
        {
            return GoapBatchVerifyProfile.RegainStamina;
        }
