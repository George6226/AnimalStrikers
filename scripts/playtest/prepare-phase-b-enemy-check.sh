...
echo "  DebugPlace: 敵 slot0（通常 Elephant）にボール保持 + 味方ゴール寄り（z≲-13）に配置"
echo "  敵シュートのみ確認: ./scripts/playtest/prepare-phase-b-enemy-shoot-check.sh"
...
echo "    ./scripts/playtest/extract-goap-logs-from-editor.sh <HH:MM> owner=Elephant"
