...
- **全員停止はなし**（P0'' 後 · #87 で main 取り込み済み）
- パス: 止まって受けるのは成功率高 · **走りながら受けは未解決**（任意 P1c）

**6-A Normal フォローアップ**

| P | 内容 | 状態 |
|---|------|------|
| P0 / P0' / P0'' | 全員停止（NoGoal / Abort / Forced Skip） | **完了 (#81+#82+#87)** · 目視 OK（2026-07-20） |
| P1 | 移動中パス受け | **△** 停止受けは実用可（#87 P1b）· ラン受けは未着手 |
