...
GOAP_EDITMODE_TEST_FILTER="${GOAP_EDITMODE_TEST_FILTER:-GoapBatchVerificationLogParserTests|TeammateNpcSupportPlanningEditModeTests|TeammateNpcDefensePlanningEditModeTests|GoapProductionSelectionExpectationsEditModeTests|GoapDefenseProductionSelectionExpectationsEditModeTests|GoapMainNpcCatalogEditModeTests|MainNpcPostPassPlanningEditModeTests|MainNpcAttackPlanningEditModeTests|GoapPassTargetSelectionEditModeTests|PassLaneKickPolicyEditModeTests|GoapFieldNpcPerspectiveEditModeTests|AnimalActionAccuracyPolicyEditModeTests|StaminaMoveSpeedEditModeTests|StaminaDashEditModeTests|StaminaChangeEditModeTests|GoalkeeperPositioningEditModeTests|GoalkeeperDistributionEditModeTests|SlideTacklePlanningEditModeTests|UseSpecialPlanningEditModeTests|ShootAimPolicyEditModeTests}"
GOAP_EDITMODE_EXPECTED_TESTS="${GOAP_EDITMODE_EXPECTED_TESTS:-240}"
